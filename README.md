...
- **Battle-Tested Stealth Mode:** Best-effort undetectable — hides from the dock, disables popups, and disguises the process during screen sharing. Not a guarantee against dedicated proctoring software, and your OS's own mic/screen-recording indicators still show when those are active.
