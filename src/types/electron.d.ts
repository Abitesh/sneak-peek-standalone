...
modesGetReferenceFileStatus: (modeId: string) => Promise<{ success: boolean; statuses?: Array<{ fileId: string; fileName: string; status: RagIndexStatus; chunkCount: number; embeddedChunkCount: number; extractedPageCount?: number; totalPageCount?: number; errorCode?: string; errorMessage?: string; updatedAt?: number }>; error?: string }>
