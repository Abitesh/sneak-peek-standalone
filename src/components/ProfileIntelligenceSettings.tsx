...
import {
    ...
    User, CheckCircle, Paperclip, FileText,
...
export function ProfileIntelligenceSettings({
    ...
    // Profile Intelligence is available without a paid entitlement in this build.
